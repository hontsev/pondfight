<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"D:\wamp64\www./application/view\user\login.html";i:1505451760;s:43:"D:\wamp64\www./application/view\header.html";i:1505395733;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <form action="<?php echo url('/index/user/login'); ?>" method="post">
      ...
      <div class="row">
	   ...
	   <br>
           ...
           <a href="<?php echo url('/index/user/register'); ?>" class="text-center">新用户注册</a>
