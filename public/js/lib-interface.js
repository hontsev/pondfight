...
BlocklyInterface.importInterpreter = function() {
  ...
  script.setAttribute('src', '/public/third-party/JS-Interpreter/compiled.js');
...
BlocklyInterface.importPrettify = function() {
  ...
  link.setAttribute('href', '/public/common/prettify.css');
  document.head.appendChild(link);
  var script = document.createElement('script');
  script.setAttribute('type', 'text/javascript');
  script.setAttribute('src', '/public/common/prettify.js');
  document.head.appendChild(script);
};
