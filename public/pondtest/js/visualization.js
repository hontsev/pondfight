...
Pond.Visualization.SPRITES.src = '/public/'+name+'/sprites.png';
...
Pond.Visualization.init = function() {
  ...
  Pond.Visualization.loadAudio_(['/public/'+name+'/whack.mp3', '/public/'+name+'/whack.ogg'], 'whack');
  Pond.Visualization.loadAudio_(['/public/'+name+'/boom.mp3', '/public/'+name+'/boom.ogg'], 'boom');
  Pond.Visualization.loadAudio_(['/public/'+name+'/splash.mp3', '/public/'+name+'/splash.ogg'],
      'splash');
