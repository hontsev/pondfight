...
Pond.soy.visualization = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="visualization"><canvas id="scratch" width="400" height="400" style="display: none"></canvas><canvas id="display" width="400" height="400"></canvas></div><table id="avatarStatTable"><tbody><tr id="avatarStatRow"></tr></tbody></table><table width="400"><tr><td style="width: 240px; text-align: center; vertical-align: top;"><button id="docsButton" title="查看脚本帮助文档">查看帮助</button></td><td><button id="runButton" class="primary" title="开始执行你的战斗脚本。"><img src="/public/common/1x1.gif" class="run icon21">开始战斗</button><button id="resetButton" class="primary" style="display: none" title="中止脚本运行，重置战场为初始状态。"><img src="/public/common/1x1.gif" class="stop icon21">结束战斗</button></td></tr></table><div id="dialogDocs"><img src="/public/common/1x1.gif" class="close icon21" id="closeDocs"><iframe id="frameDocs"></iframe></div>';
};
if (goog.DEBUG) {
